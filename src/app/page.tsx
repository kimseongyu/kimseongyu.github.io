            ...
            <section>
              ...
              <div className={styles.introBox}>
                ...
                <p className={styles.introBody}>
                  단순히 화면을 구현하는 것을 넘어, 성능 최적화를 통해 사용자
                  경험을 개선하는 데 관심을 가지고 있습니다. 웹 뿐만 아니라
                  시스템 소프트웨어 프로젝트들을 통해 쌓은 최적화 능력과
                  오픈소스 활용 및 기여 경험을 바탕으로, 기술의 깊이와 사용자
                  가치를 고민합니다.
                </p>
              </div>
            </section>
              ...
              <div className={styles.itemStack}>
                  ...
                  <ul className={styles.bulletBox}>
                    <li>
                      ...
                      <ul className={styles.bulletNested}>
                        <li>
                          AI가 시나리오/테스트케이스를 생성하는 동안의 대기로
                          인한 사용자 경험 저하를 줄이기 위해, Next.js의 SSR과
                          CSR을 혼합한 하이브리드 렌더링을 적용했습니다.
                        </li>
                      </ul>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <ul className={styles.bulletNested}>
                        <li>
                          API 명세를 기반으로 json-server를 활용한 Mock API
                          서버를 구축했습니다.
                        </li>
                        <li>
                          백엔드 개발 완료 전 프론트엔드를 독립적으로
                          개발·테스트하여 개발 기간 단축 및 API 인터페이스
                          검증에 활용했습니다.
                        </li>
                      </ul>
                    </li>
                ...
                <div>
                  ...
                  <p className={styles.descriptionBox}>
                    ...
                    보완하여 정밀도를 높이는 분석 도구를 개발했습니다. 이를
                    통해, 개발자가 바이너리를 더 정확하게 이해하고 분석할 수
                    있는 환경을 구축했습니다.
                  </p>
                  <p className={styles.itemLabel}>성과 및 기여</p>
                  <ul className={styles.bulletBox}>
                ...
                <div>
                  ...
                  <p className={styles.descriptionBox}>
                    ...
                    소스 코드에서 누수가 발생한 영역을 할당했던 시점을
                    사용자에게 출력합니다. 어디서 메모리 누수 발생 지점을 정확히
                    특정하는 것은 개발자 경험 향상에 중요한 요소로, 이를
                    개선하기 위해 메모리 누수 발생 지점 탐지 도구를
                    개발했습니다.
                  </p>
                  <p className={styles.itemLabel}>성과 및 기여</p>
                  <ul className={styles.bulletBox}>
                    ...
                    <li>
                      ...
                      <ul className={styles.bulletNested}>
                        ...
                        <li>
                          LLVM Integrated Tester를 활용하여 기존 테스트를
                          정제하여 17개의 테스트 케이스를 생성하고, 15개를
                          통과시켜 도구의 높은 정확도를 입증했습니다.
                        </li>
                      </ul>
                    </li>
                  </ul>
